...
return function(config)
  ...
  return {
    get = function (top, bottom, win)
      ...
      local scope = MINI_INDENTSCOPE.get_scope(win.cursor[1], win.cursor[2]+1, args)
      if not scope.body.top or not scope.body.bottom then
        return nil
      end
      local diff = scope.body.bottom - scope.body.top
      ...
      return {scope.body.top-1, scope.body.bottom+1}
    end
  }
end
